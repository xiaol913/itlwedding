...
class WeddingInfo(models.Model):
    ...
    海外婚礼详情页
    """
    area_id = models.ForeignKey(WeddingArea, verbose_name="婚礼区域", help_text="婚礼区域", related_name="info")
    ...
    front_img = models.ImageField(upload_to="images/wedding/front/", max_length=200,
...
class WeddingInfoImage(models.Model):
    """
    海外婚礼详情页图片（最多12张）
    """
    name = models.ForeignKey(WeddingInfo, verbose_name="详情", help_text="详情", related_name="images")
